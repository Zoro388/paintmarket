...
export default function RegisterPage() {
  ...
  // Light-themed inputs
  const inputCls =
    "w-full bg-[#F8F5F0] border border-[rgba(197,154,70,0.3)] text-[#1F1F1F] placeholder:text-[#9A9A9A] px-4 py-2.5 rounded-lg text-sm focus:outline-none focus:border-[#C59A46] focus:ring-1 focus:ring-[#C59A46] focus:bg-white transition-all";
  ...
  return (
    ...
    >
      <div
        className={`w-full ${
          activeTab === "painter" ? "max-w-2xl" : "max-w-md"
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: COLORS.secondaryText }}>
            {activeTab === "customer"
              ...
              : "Grow your painting business with us"}
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {/* Painter Specific Metadata Section */}
            {activeTab === "painter" && (
              <div
                className="border-t pt-4 mt-2 flex flex-col gap-5"
                style={{ borderColor: COLORS.border }}
              >
                <div
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div
                      className="flex flex-wrap gap-2 bg-[#F8F5F0] border p-3 rounded-lg min-h-[90px]"
                      style={{ borderColor: COLORS.border }}
                    >
                      {dbSkills.length > 0 ? (
                        dbSkills.map((item) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-all ${
                                isSelected
                                  ? "bg-[#C59A46] text-white border-[#C59A46] shadow-sm"
                                  : "bg-white text-[#7A7A7A] border-[rgba(197,154,70,0.3)] hover:border-[#C59A46] hover:text-[#1F1F1F]"
                              }`}
                            >
                              {item.name}
                            </button>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mt-2">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    {!profilePreview ? (
                      <label
                        className="flex flex-col items-center justify-center gap-1 border border-dashed rounded-lg p-4 text-center text-[11px] cursor-pointer transition-colors min-h-[90px] bg-[#F8F5F0]"
                        style={{
                      ...
                      <div
                        className="relative w-full h-[90px] rounded-lg overflow-hidden border bg-[#F8F5F0]"
                        style={{ borderColor: COLORS.border }}
                      >
                        <img
                          src={profilePreview}
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    {portfolioPreviews.length > 0 && (
                      <div
                        className="grid grid-cols-3 gap-1 mt-1 max-h-16 overflow-y-auto p-1 bg-white rounded border"
                        style={{ borderColor: COLORS.border }}
                      >
                        {portfolioPreviews.map((url, i) => (
                          <div
                            key={i}
                            className="relative aspect-square rounded overflow-hidden border bg-[#F8F5F0]"
                            style={{ borderColor: COLORS.border }}
                          >
                            <img
                              src={url}
                            ...
                            <button
                              ...
                              className="absolute top-0.5 right-0.5 bg-black/80 p-0.5 rounded-full text-white"
                            >
                              <X size={10} />
                            </button>
                          </div>
            ...
            <div
              className="grid sm:grid-cols-2 gap-4 border-t pt-4 mt-2"
              style={{ borderColor: COLORS.border }}
            >
              <div className="flex flex-col gap-1.5">
                <label
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center justify-center gap-2 text-white font-semibold px-6 py-3 rounded-lg transition-all shadow-md active:scale-[0.99] disabled:opacity-50 mt-3 text-sm"
