                      ...
                      >
                        ...
                        {p.productImages && p.productImages.length > 0 && (
                          <Image
                            ...
                            className="h-[85%] w-auto object-contain mix-blend-multiply drop-shadow-md z-10 cursor-pointer hover:scale-105 transition-transform duration-200"
                            onError={(e) => {
                              (e.target as HTMLElement).style.display = 'none';
                            }}
                          />
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 z-10 bg-brand-black/70 border border-brand-border text-white p-2.5 rounded-full hover:bg-brand-raised transition-colors shadow-lg"
            >
              <X size={20} />
            </button>
            <Image
